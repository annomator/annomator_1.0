...
# AZA CHANGE for following error
# ValueError: Tried to convert 't' to a tensor and failed. Error: Argument must be a dense tensor: range(0, 3) - got shape [3], but wanted [].
# ref github and is supposed to be python 3 only error
# see github #3443 #3705
...
def manual_stepping(global_step, boundaries, rates, warmup=False):
  ...
  # ORIG rate_index = tf.reduce_max(tf.where(tf.greater_equal(global_step, boundaries),
  # ORIG                                     range(num_boundaries),
  # ORIG                                     [0] * num_boundaries))
